...
import 'package:angulardart_components/material_datepicker/material_month_picker.scss.css.shim.dart' as import0;
...
final List<Object> styles$MaterialMonthPickerComponent = [import0.styles];
...
class ViewMaterialMonthPickerComponent0 extends import1.ComponentView<import2.MaterialMonthPickerComponent> {
  ...
  ViewMaterialMonthPickerComponent0(import4.View parentView, int parentIndex) : super(parentView, parentIndex, ChangeDetectionStrategy.CheckOnce) {
    ...
    this.rootElement = import6.renderFactory.createElement('material-month-picker');
  }
  static String? get _debugComponentUrl {
    return (import7.isDevMode ? 'asset:angulardart_components/lib/material_datepicker/material_month_picker.dart' : null);
  }
  ...
  void build() {
    ...
    this.addShimC(_el_1);
    _ctx.container = import8.unwrapNode(_el_1);
  }
...
final List<Object> styles$MaterialMonthPickerComponentHost = const [];
  ...
  void build() {
    ...
    this.component = (import7.isDevMode
        ? import11.debugInjectorWrap(import2.MaterialMonthPickerComponent, () {
            return import2.MaterialMonthPickerComponent(this.injectorGetOptional(const import12.OpaqueToken<Object>('third_party.dart_src.acx.material_datepicker.datepickerClock'), this.parentIndex), null);
          })
        : import2.MaterialMonthPickerComponent(this.injectorGetOptional(const import12.OpaqueToken<Object>('third_party.dart_src.acx.material_datepicker.datepickerClock'), this.parentIndex), null));
