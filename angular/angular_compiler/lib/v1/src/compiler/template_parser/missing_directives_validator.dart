import 'package:angulardart_compiler/v1/src/compiler/aria_attributes.dart';
import 'package:angulardart_compiler/v1/src/compiler/html_events.dart';
import 'package:angulardart_compiler/v1/src/compiler/schema/element_schema_registry.dart';
import 'package:angulardart_compiler/v1/src/compiler/schema/skip_selectors_validator.dart';
...
import 'package:angulardart_compiler/v1/src/compiler/template_parser/recursive_template_visitor.dart';
...
class MissingDirectiveValidator
  ...
  @override
  void visitAttr(ng.AttrAst ast, [MissingDirectiveContext? context]) {
  ...
  @override
  void visitEvent(ng.BoundEventAst ast, [MissingDirectiveContext? context]) {
