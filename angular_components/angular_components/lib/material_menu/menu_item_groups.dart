...
import 'package:angulardart_components/focus/focus_activable_item.dart';
...
import 'package:angulardart_components/material_menu/menu_item_affix_list.dart';
...
class MenuItemGroupsComponent
  ...
  void _openSubMenuOnHover() {
    if (_hoveredItem != null) _openSubMenu(_hoveredItem!);
    _changeDetector.markForCheck();
  }
