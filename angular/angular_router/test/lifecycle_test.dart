...
void main() {
  ...
  test('navigate to and from a sibling', () async {
    final fixture = await setup<TestNavigateToSibling>(ng.createTestNavigateToSiblingFactory());
  ...
  test('navigate to a nested sibling and back', () async {
    final fixture = await setup<TestNavigateToNestedSibling>(ng.createTestNavigateToNestedSiblingFactory());
    final log = fixture.assertOnlyInstance.lifecycleLog;
    final router = fixture.assertOnlyInstance.router;
    expect(log, [
  ...
  test('navigate between nested routes with a reusable parent', () async {
    final fixture = await setup<TestNavigateBetweenNestedRoutesWithReusableParent>(
  ...
  test('navigate between nested routes with the same reusable parent',
      () async {
    final fixture = await setup<TestNavigateBetweenNestedRoutesWithSameReusableParent>(
  ...
  test('prevent navigation before other lifecycle callbacks', () async {
    final fixture = await setup<TestPreventNavigation>(ng.createTestPreventNavigationFactory());
    final log = fixture.assertOnlyInstance.lifecycleLog;
    final router = fixture.assertOnlyInstance.router;
    expect(log, [
  ...
  test('redirect to a sibling', () async {
    final fixture = await setup<TestRedirectToSibling>(ng.createTestRedirectToSiblingFactory());
    final log = fixture.assertOnlyInstance.lifecycleLog;
    final router = fixture.assertOnlyInstance.router;
    expect(log, [
      '$FirstChildComponent[0].ngOnInit',
