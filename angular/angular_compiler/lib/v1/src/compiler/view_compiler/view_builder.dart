...
import 'package:angulardart_compiler/v1/src/compiler/view_compiler/bound_value_converter.dart';
import 'package:angulardart_compiler/v1/src/compiler/view_compiler/update_statement_visitor.dart';
...
o.Constructor _createComponentViewConstructor(CompileView view) {
  ...
  // The same generated code works in both browser and server contexts.
