...
PropertyInducingElement? _getField(AnalyzedClass clazz, String name) {
  var getter =
      clazz.classElement.lookUpGetter(name: name, library: clazz.classElement.library);
...
bool isImmutable(ast.AST expression, AnalyzedClass? analyzedClass) {
  ...
  if (expression is ast.PropertyRead) {
    ...
    if (receiver is ast.ImplicitReceiver ||
      ...
      if (field != null) {
        return !field.isOriginDeclaration && (field.isFinal || field.isConst);
      }
...
ast.ASTWithSource rewriteTearOff(
  ...
  if (unwrappedExpression is ast.PropertyRead) {
    ...
    final method = analyzedClass.classElement.lookUpMethod(
      name: unwrappedExpression.name,
      library: analyzedClass.classElement.library,
    );
    ...
    final positionalParameters = method.formalParameters.where((p) => !p.isNamed);
...
class _TypeResolver extends ast.AstVisitor<DartType, dynamic> {
  ...
  @override
  DartType visitBinary(ast.Binary ast, context) {
  ...
  @override
  DartType visitEmptyExpr(ast.EmptyExpr ast, context) => _dynamicType;

  @override
  DartType visitFunctionCall(ast.FunctionCall ast, context) => _dynamicType;

  @override
  DartType visitIfNull(ast.IfNull ast, context) => _dynamicType;

  @override
  DartType visitImplicitReceiver(ast.ImplicitReceiver ast, context) =>
      _implicitReceiverType;

  @override
  DartType visitInterpolation(ast.Interpolation ast, context) {
  ...
  @override
  DartType visitKeyedRead(ast.KeyedRead ast, context) => _dynamicType;

  @override
  DartType visitKeyedWrite(ast.KeyedWrite ast, context) => _dynamicType;

  @override
  DartType visitLiteralPrimitive(ast.LiteralPrimitive ast, context) =>
      ast.value is String ? _stringType : _dynamicType;

  @override
  DartType visitLiteralList(ast.LiteralList ast, context) => _dynamicType;

  @override
  DartType visitLiteralMap(ast.LiteralMap ast, context) => _dynamicType;

  @override
  DartType visitMethodCall(ast.MethodCall ast, context) {
    var receiverType = ast.receiver.visit(this, context);
    return _lookupMethodReturnType(receiverType, ast.name);
  }

  @override
  DartType visitNamedExpr(ast.NamedExpr ast, context) => _dynamicType;

  @override
  DartType visitPipe(ast.BindingPipe ast, context) => _dynamicType;

  @override
  DartType visitPrefixNot(ast.PrefixNot ast, context) => _dynamicType;

  @override
  DartType visitPostfixNotNull(ast.PostfixNotNull ast, context) => _dynamicType;

  @override
  DartType visitPropertyRead(ast.PropertyRead ast, context) {
    var receiverType = ast.receiver.visit(this, context);
  ...
  @override
  DartType visitPropertyWrite(ast.PropertyWrite ast, context) => _dynamicType;

  @override
  DartType visitSafeMethodCall(ast.SafeMethodCall ast, context) {
    var receiverType = ast.receiver.visit(this, context);
    return _lookupMethodReturnType(receiverType, ast.name);
  }

  @override
  DartType visitSafePropertyRead(ast.SafePropertyRead ast, context) {
    var receiverType = ast.receiver.visit(this, context);
    return _lookupGetterReturnType(receiverType, ast.name);
  }

  @override
  DartType visitStaticRead(ast.StaticRead ast, context) =>
      ast.id.analyzedClass == null
          ? _dynamicType
          : ast.id.analyzedClass!.classElement.thisType;

  @override
  DartType visitVariableRead(ast.VariableRead ast, context) => _dynamicType;
  ...
  DartType _lookupGetterReturnType(DartType receiverType, String getterName) {
    if (receiverType is InterfaceType) {
      var getter = receiverType.element.lookUpGetter(name: getterName, library: receiverType.element.library);
  ...
  DartType _lookupMethodReturnType(DartType receiverType, String methodName) {
    if (receiverType is InterfaceType) {
      var method = receiverType.element.lookUpMethod(name: methodName, library: receiverType.element.library);
