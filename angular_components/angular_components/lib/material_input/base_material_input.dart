...
class BaseMaterialInput extends FocusableMixin
  ...
  final _blurController = StreamController<web.FocusEvent>.broadcast(sync: true);

  @Output('blur')
  Stream<web.FocusEvent> get onBlur => _blurController.stream;
...
class BaseSingleLineInputComponent extends BaseMaterialInput
  ...
  @visibleForTemplate
  void handleChange(web.Event event, web.HTMLInputElement element) {
    inputChange(
      element.value,
