...
import 'package:angulardart_router/src/location/location.dart' as _i1;
import 'package:angulardart_router/src/router_hook.dart' as _i2;
...
void initReflector() {
  ...
  _ngRef.registerFactory(RouterImpl, (_i1.Location p0, _i2.RouterHook? p1) => RouterImpl.new(p0, p1));
