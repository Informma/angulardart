...
class LazyStreamController<T> implements StreamController<T> {
  ...
  @override
  Future<void> get done => _initializeLazy().done;
  ...
  @override
  void Function()? get onListen => _initializeLazy().onListen;
  ...
  @override
  void Function()? get onPause => _initializeLazy().onPause;
  ...
  @override
  void Function()? get onResume => _initializeLazy().onResume;
  ...
  @override
  FutureOr<void> Function()? get onCancel => _initializeLazy().onCancel;
}
