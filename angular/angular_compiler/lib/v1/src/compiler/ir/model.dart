...
import 'package:angulardart_compiler/v1/src/compiler/view_compiler/compile_element.dart';
import 'package:angulardart_compiler/v1/src/compiler/view_compiler/compile_view.dart';
import 'package:angulardart_compiler/v1/src/compiler/view_compiler/ir/provider_source.dart';
import 'package:angulardart_compiler/v1/src/compiler/view_compiler/view_compiler_utils.dart'
    show namespaceUris;
...
class HostView implements View {
  ...
  @override
  List<IRNode> get children => const [];
}
...
class Binding implements IRNode {
  ...
  Binding({required this.source, required this.target, this.isDirect = false});
...
class AttributeBinding implements BindingTarget {
  ...
  }) : namespace = namespaceUris[namespace];
...
class BoundI18nMessage implements BindingSource {
  ...
  @override
  final bool isDouble = false;
  @override
  final bool isInt = false;
...
class BoundExpression implements BindingSource {
  ...
  @override
  bool get isBool => analyzed.isBool(expression.ast, _analyzedClass!);

  @override
  bool get isNumber => analyzed.isNumber(expression.ast, _analyzedClass!);

  @override
  bool get isDouble => analyzed.isDouble(expression.ast, _analyzedClass!);
