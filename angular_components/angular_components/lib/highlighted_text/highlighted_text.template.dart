...
import 'package:angulardart_components/model/ui/highlighted_text_model.template.dart' as _ref1;
...
final List<Object> styles$HighlightedTextComponent = [import0.styles];
...
class ViewHighlightedTextComponent0 extends import1.ComponentView<import2.HighlightedTextComponent> {
  ...
  ViewHighlightedTextComponent0(import6.View parentView, int parentIndex) : super(parentView, parentIndex, ChangeDetectionStrategy.CheckOnce) {
    ...
    this.rootElement = import8.renderFactory.createElement('highlighted-text');
  }
  static String? get _debugComponentUrl {
    return (import9.isDevMode ? 'asset:angulardart_components/lib/highlighted_text/highlighted_text.dart' : null);
  }
  ...
  void build() {
    ...
    var _TemplateRef_1_8 = TemplateRef(this._appEl_1, viewFactory_HighlightedTextComponent1);
...
class _ViewHighlightedTextComponent1 extends import15.EmbeddedView<import2.HighlightedTextComponent> {
  final import16.TextBinding _textBinding_1 = import16.TextBinding();
  Object? _expr_0;
  late final _el_0;
  _ViewHighlightedTextComponent1(import17.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
...
import15.EmbeddedView<void> viewFactory_HighlightedTextComponent1(import17.RenderView parentView, int parentIndex) {
  return _ViewHighlightedTextComponent1(parentView, parentIndex);
}

final List<Object> styles$HighlightedTextComponentHost = const [];

class _ViewHighlightedTextComponentHost0 extends import19.HostView<import2.HighlightedTextComponent> {
  @override
  void build() {
...
import19.HostView<import2.HighlightedTextComponent> viewFactory_HighlightedTextComponentHost0() {
