...
class Denomination {
  ...
  @Deprecated('Use hundreds instead')
  // ignore: constant_identifier_names
  static const Hundreds = hundreds;
  @Deprecated('Use thousands instead')
  // ignore: constant_identifier_names
  static const Thousands = thousands;
  @Deprecated('Use millions instead')
  // ignore: constant_identifier_names
  static const Millions = millions;
  @Deprecated('Use billions instead')
  // ignore: constant_identifier_names
  static const Billions = billions;
  @Deprecated('Use trillions instead')
  // ignore: constant_identifier_names
  static const Trillions = trillions;
  ...
  static Denomination? fromSuffix(String suffix) {
