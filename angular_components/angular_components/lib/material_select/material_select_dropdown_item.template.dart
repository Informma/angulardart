...
import 'package:angulardart_components/glyph/glyph.template.dart' as _ref2;
import 'package:angulardart_components/material_checkbox/material_checkbox.template.dart' as _ref3;
import 'package:angulardart_components/material_select/activation_handler.template.dart' as _ref4;
import 'package:angulardart_components/material_select/handles_aria.template.dart' as _ref5;
import 'package:angulardart_components/material_select/material_select_item.template.dart' as _ref6;
...
import 'package:angulardart_components/model/ui/has_renderer.template.dart' as _ref9;
import 'package:angulardart_components/src/dom/dom_apis.template.dart' as _ref10;
import 'package:angulardart_components/utils/id_generator/id_generator.template.dart' as _ref11;
import 'package:angulardart_components/material_select/material_select_dropdown_item.scss.css.shim.dart' as import0;
...
import '../utils/id_generator/id_generator.dart' as import31;
import '../model/selection/selection_container.dart' as import32;
import '../model/ui/has_renderer.dart' as import33;

final List<Object> styles$MaterialSelectDropdownItemComponent = [import0.styles];

class ViewMaterialSelectDropdownItemComponent0<T> extends import1.ComponentView<import2.MaterialSelectDropdownItemComponent<T>> {
  ...
  ViewMaterialSelectDropdownItemComponent0(import6.View parentView, int parentIndex) : super(parentView, parentIndex, ChangeDetectionStrategy.CheckOnce) {
    this.initComponentStyles();
    this.rootElement = import8.renderFactory.createElement('material-select-dropdown-item');
  }
  static String? get _debugComponentUrl {
    return (import9.isDevMode ? 'asset:angulardart_components/lib/material_select/material_select_dropdown_item.dart' : null);
  }
  ...
  void build() {
    ...
    var _TemplateRef_0_8 = TemplateRef(this._appEl_0, (parentView, parentIndex) {
      return viewFactory_MaterialSelectDropdownItemComponent1<T>(parentView, parentIndex);
    });
    ...
    var _TemplateRef_2_8 = TemplateRef(this._appEl_2, (parentView, parentIndex) {
      return viewFactory_MaterialSelectDropdownItemComponent2<T>(parentView, parentIndex);
    });
    ...
    var _TemplateRef_4_8 = TemplateRef(this._appEl_4, (parentView, parentIndex) {
      return viewFactory_MaterialSelectDropdownItemComponent6<T>(parentView, parentIndex);
    });
    ...
    var _TemplateRef_6_8 = TemplateRef(this._appEl_6, (parentView, parentIndex) {
      return viewFactory_MaterialSelectDropdownItemComponent7<T>(parentView, parentIndex);
    });
    ...
    import10.addRenderEventListener(parentRenderNode, 'mousedown', this.eventHandler1(_ctx.preventTextSelectionIfShiftKey));
  }
  ...
  void detectHostChanges(bool firstCheck) {
    ...
    if (import13.checkBinding(this._expr_8, currVal_8, null, null)) {
      import10.updateRenderClass(this.rootElement, 'hidden', (currVal_8 ?? false));
      this._expr_8 = currVal_8;
    }
    final currVal_9 = _ctx.id;
    if (import13.checkBinding(this._expr_9, currVal_9, null, null)) {
      import10.updateRenderAttribute(this.rootElement, 'id', currVal_9);
      this._expr_9 = currVal_9;
    }
    final currVal_10 = _ctx.isSelected;
    if (import13.checkBinding(this._expr_10, currVal_10, null, null)) {
      import10.updateRenderAttribute(this.rootElement, 'aria-selected', currVal_10?.toString());
      this._expr_10 = currVal_10;
    }
    final currVal_11 = import2.MaterialSelectDropdownItemComponent.hostClass;
    if (import13.checkBinding(this._expr_11, currVal_11, null, null)) {
      this.updateChildClassNonHtml(this.rootElement, currVal_11);
  ...
  void initComponentStyles() {
    ...
    if ((styles == null)) {
      _componentStyles = (styles = import5.ComponentStyles.scoped(styles$MaterialSelectDropdownItemComponent, _debugComponentUrl));
...
const _MaterialSelectDropdownItemComponentNgFactory = ComponentFactory<import2.MaterialSelectDropdownItemComponent>('material-select-dropdown-item', viewFactory_MaterialSelectDropdownItemComponentHost0);
...
ComponentFactory<import2.MaterialSelectDropdownItemComponent<T>> createMaterialSelectDropdownItemComponentFactory<T>() {
  return ComponentFactory('material-select-dropdown-item', viewFactory_MaterialSelectDropdownItemComponentHost0);
}

class _ViewMaterialSelectDropdownItemComponent1<T> extends import15.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  _ViewMaterialSelectDropdownItemComponent1(import16.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
...
import15.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent1<T>(import16.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent1<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent2<T> extends import15.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  late final ViewContainer _appEl_0;
  late final NgIf _NgIf_0_9;
  late final ViewContainer _appEl_2;
  late final NgIf _NgIf_2_9;
  _ViewMaterialSelectDropdownItemComponent2(import16.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
    final _anchor_0 = import10.createRenderAnchor();
    this._appEl_0 = ViewContainer(0, null, this, _anchor_0);
    var _TemplateRef_0_8 = TemplateRef(this._appEl_0, (parentView, parentIndex) {
      return viewFactory_MaterialSelectDropdownItemComponent3<T>(parentView, parentIndex);
    });
    this._NgIf_0_9 = NgIf(this._appEl_0, _TemplateRef_0_8);
    if (import12.isDevToolsEnabled) {
      import12.Inspector.instance.registerDirective(_anchor_0, this._NgIf_0_9);
    ...
    this._appEl_2 = ViewContainer(2, null, this, _anchor_2);
    var _TemplateRef_2_8 = TemplateRef(this._appEl_2, (parentView, parentIndex) {
      return viewFactory_MaterialSelectDropdownItemComponent4<T>(parentView, parentIndex);
    });
    this._NgIf_2_9 = NgIf(this._appEl_2, _TemplateRef_2_8);
    if (import12.isDevToolsEnabled) {
      import12.Inspector.instance.registerDirective(_anchor_2, this._NgIf_2_9);
...
import15.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent2<T>(import16.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent2<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent3<T> extends import15.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  ...
  Object? _expr_0;
  Object? _expr_1;
  _ViewMaterialSelectDropdownItemComponent3(import16.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
...
import15.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent3<T>(import16.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent3<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent4<T> extends import15.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  late final ViewContainer _appEl_1;
  late final NgIf _NgIf_1_9;
  _ViewMaterialSelectDropdownItemComponent4(import16.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
    ...
    var _TemplateRef_1_8 = TemplateRef(this._appEl_1, (parentView, parentIndex) {
      return viewFactory_MaterialSelectDropdownItemComponent5<T>(parentView, parentIndex);
    });
...
import15.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent4<T>(import16.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent4<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent5<T> extends import15.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  late final import20.ViewGlyphComponent0 _compView_0;
  late final import21.GlyphComponent _GlyphComponent_0_5;
  _ViewMaterialSelectDropdownItemComponent5(import16.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
...
import15.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent5<T>(import16.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent5<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent6<T> extends import15.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  final import22.TextBinding _textBinding_1 = import22.TextBinding();
  _ViewMaterialSelectDropdownItemComponent6(import16.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
    final _el_0 = import10.createRenderElement('span');
...
import15.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent6<T>(import16.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent6<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent7<T> extends import15.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  ...
  Object? _expr_1;
  Object? _expr_2;
  _ViewMaterialSelectDropdownItemComponent7(import16.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
    final _ctx = this.ctx;
...
import15.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent7<T>(import16.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent7<T>(parentView, parentIndex);
}

final List<Object> styles$MaterialSelectDropdownItemComponentHost = const [];

class _ViewMaterialSelectDropdownItemComponentHost0<T> extends import28.HostView<import2.MaterialSelectDropdownItemComponent<T>> {
  @override
  void build() {
    this.componentView = ViewMaterialSelectDropdownItemComponent0(this, 0);
    final _el_0 = this.componentView.rootElement;
    this.component = (import9.isDevMode
        ? import26.debugInjectorWrap(import2.MaterialSelectDropdownItemComponent, () {
            return import2.MaterialSelectDropdownItemComponent(import10.unwrapNode(_el_0), null, this.injectorGetOptional(import29.DropdownHandle, this.parentIndex), this.injectorGetOptional(import30.ActivationHandler, this.parentIndex), this.injectorGetOptional(import31.IdGenerator, this.parentIndex), this.componentView);
          })
        : import2.MaterialSelectDropdownItemComponent(import10.unwrapNode(_el_0), null, this.injectorGetOptional(import29.DropdownHandle, this.parentIndex), this.injectorGetOptional(import30.ActivationHandler, this.parentIndex), this.injectorGetOptional(import31.IdGenerator, this.parentIndex), this.componentView));
    this.initRootNode(_el_0);
  }

  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if (((identical(token, import32.SelectionItem) || identical(token, import33.HasRenderer)) && (0 == nodeIndex))) {
...
import28.HostView<import2.MaterialSelectDropdownItemComponent<T>> viewFactory_MaterialSelectDropdownItemComponentHost0<T>() {
...
void initReflector() {
  ...
  _ngRef.registerComponent(MaterialSelectDropdownItemComponent, createMaterialSelectDropdownItemComponentFactory());
  _ref0.initReflector();
  _ref1.initReflector();
  _ref2.initReflector();
  _ref3.initReflector();
