...
import 'package:angulardart_components/material_datepicker/config.dart';
import 'package:angulardart_components/material_datepicker/date_range_editor.dart';
...
class MaterialDateRangePickerComponent
  ...
  String _getFormattedComparison(DatepickerComparison? value) =>
      _compareMsg(value?.comparison != null ? rangeFormatter(value!.comparison!) : '');
