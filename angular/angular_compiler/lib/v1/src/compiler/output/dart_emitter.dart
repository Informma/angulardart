...
class _DartEmitterVisitor extends AbstractEmitterVisitor
  ...
  static const _allowListedImports = [
    'package:angulardart/angulardart.dart',
    'dart:core',
    // ElementRef.
    'asset:angulardart/lib/src/core/linker/element_ref.dart',
    'package:angulardart/src/core/linker/element_ref.dart',
    // ViewContainer.
    'asset:angulardart/lib/src/core/linker/view_container.dart',
    'package:angulardart/src/core/linker/view_container.dart',
    // TemplateRef.
    'asset:angulardart/lib/src/core/linker/template_ref.dart',
    'package:angulardart/src/core/linker/template_ref.dart',
    // ChangeDetectionStrategy, Differs*
    'asset:angulardart/lib/src/core/change_detection/change_detection.dart',
    'package:angulardart/src/core/change_detection/change_detection.dart',
    // NgIf.
    'asset:angulardart/lib/src/common/directives/ng_if.dart',
    'package:angulardart/src/common/directives/ng_if.dart',
    // AppView.
    'asset:angulardart/lib/src/core/linker/app_view.dart',
    'package:angulardart/src/core/linker/app_view.dart',
    // RenderComponentType.
    'asset:angulardart/lib/src/core/render/api.dart',
    'package:angulardart/src/core/render/api.dart',
  ];
  ...
  void _visitClassConstructor(o.ClassStmt stmt, EmitterVisitorContext context) {
    ...
    if (ctorStmts.isEmpty) {
      ...
      context.println(' {');
      context.incIndent();
      visitAllStatements(ctorStmts.whereType<o.Statement>().toList(), context);
      context.decIndent();
      context.println('}');
    }
  }
