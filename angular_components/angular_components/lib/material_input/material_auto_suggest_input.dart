...
import 'package:angulardart_components/material_select/material_select_base.dart';
...
import 'package:angulardart_components/mixins/highlight_assistant_mixin.dart';
import 'package:angulardart_components/mixins/material_dropdown_base.dart';
import 'package:angulardart_components/mixins/selection_input_adapter.dart';
import 'package:angulardart_components/model/a11y/active_item.dart';
import 'package:angulardart_components/model/a11y/active_item_directive.dart';
...
import 'package:angulardart_components/stop_propagation/stop_propagation.dart';
...
class MaterialAutoSuggestInputComponent<T> extends MaterialSelectBase<T>
  ...
  late MaterialInputComponent _input;
  late _InputChangeCallback _callback;
  ...
  late DisposableFuture _lastFilterFuture;
  ...
  late StreamSubscription _selectionListener;

  /// Listener for selection options changes.
  late StreamSubscription _optionsListener;
  ...
  set componentRenderer(ComponentRenderer<RendersValue<dynamic>, Object> value) =>
  ...
  @Input()
  late ComponentRenderer labelRenderer;
