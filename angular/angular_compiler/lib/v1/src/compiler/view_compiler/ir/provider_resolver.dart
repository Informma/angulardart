...
class BuiltInSource extends ProviderSource {
  ...
  BuiltInSource(CompileTokenMetadata super.token, this._value);
...
class FactoryProviderSource extends ProviderSource {
  ...
  FactoryProviderSource(
      CompileTokenMetadata super.token, this._factory, this._parameters);
...
class ClassProviderSource extends ProviderSource {
  ...
  ClassProviderSource(
    CompileTokenMetadata super.token,
    this._classType,
    this._parameters, {
    List<o.OutputType> typeArguments = const [],
