...
export 'package:angulardart_compiler/v1/src/compiler/compile_metadata.dart'
    show CompileDirectiveMetadata;
export 'package:angulardart_compiler/v1/src/compiler/template_compiler.dart'
    show AngularArtifacts, NormalizedComponentWithViewDirectives;
export 'package:angulardart_compiler/v1/src/compiler/template_parser/ast_template_parser.dart'
