...
import 'package:angulardart_compiler/v1/src/compiler/view_compiler/property_binder.dart'
    show isPrimitiveTypeName;
import 'package:angulardart_compiler/v1/src/source_gen/common/annotation_matcher.dart';
import 'package:angulardart_compiler/v1/src/source_gen/common/url_resolver.dart';
...
class _ComponentVisitor
  ...
  static final _htmlElement = TypeChecker.fromUrl('package:web/src/dom/dom.dart#Element');
